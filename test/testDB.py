from dal import sys_user,oldperson_info
import time
...
#oldperson_info.add_old_person_info("wll","male","13031170798","111111111111111111",time.strftime("%Y-%m-%d", time.localtime()),time.strftime("%Y-%m-%d", time.localtime()),time.strftime("%Y-%m-%d", time.localtime()),
